(async function() {
    ...
    function loadScript(file) {
        return new Promise(function(resolve) {
            ...
            const existing = document.querySelector('script[data-ejs-src="' + src + '"]');
            if (existing) {
                resolve();
                return;
            }
            let script = document.createElement("script");
            script.dataset.ejsSrc = src;
    ...
    function loadStyle(file) {
        return new Promise(function(resolve) {
            ...
            const existing = document.querySelector('link[data-ejs-href="' + href + '"]');
            if (existing) {
                resolve();
                return;
            }
            let css = document.createElement("link");
            css.dataset.ejsHref = href;
            css.rel = "stylesheet";
